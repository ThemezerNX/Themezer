    ...
    },
    {
        ...
        list: [
            ...
            },
            {
                ...
                content:
                    "Consider adding a customization option to the original in the Layouts GitHub repository (see the 'Layout' submit page in the menu). If you don't want to, make sure to change the 'ID' of the layout json to something like 'custom'. If you don't, Themezer will force-select the original layout.",
            },
            {
                title:
