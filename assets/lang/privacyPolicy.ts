export default [
    ...
    },
    {
        ...
        list: [
            {
                title: "Discord Inc.",
                content: "Our website uses authentication services (OAuth2) from Discord Inc. Your Discord username, id and profile picture url are saved for identification on our website.",
            },
            {
